...
final Map<String, List<MovieDetails>> movieDatabase = {
  "Romance": [
    ...
    MovieDetails(
      name: "Made of Honor",
      movieInfo: "Paul Weiland 2008",
      imdb: "https://www.imdb.com/title/tt0866439/",
      wiki: "https://en.wikipedia.org/wiki/Made_of_Honor",
      imagePath: "assets/made_of_honor.jpg",
      route: MoviePage(
        title: "Made of Honor",
        imdb: "https://www.imdb.com/title/tt0866439/",
        imagePath: "assets/made_of_honor.jpg",
      ...
      fullMovieInfo: FullMovieInfo(
        ...
        duration: "1h 41m",
        ratings: ["Rotten Tomatoes: 16%", "IMDb: 5.9/10"],
      ),
    ),
  ],
  "Drama": [
